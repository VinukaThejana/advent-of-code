...
func part1() {
	...
	for scanner.Scan() {
		...
		switch data.From {
		case 1:
			stack1, buf = liftCratesPart1(stack1, buf, data.Count)
			break
		case 2:
			stack2, buf = liftCratesPart1(stack2, buf, data.Count)
			break
		case 3:
			stack3, buf = liftCratesPart1(stack3, buf, data.Count)
			break
		case 4:
			stack4, buf = liftCratesPart1(stack4, buf, data.Count)
			break
		case 5:
			stack5, buf = liftCratesPart1(stack5, buf, data.Count)
			break
		case 6:
			stack6, buf = liftCratesPart1(stack6, buf, data.Count)
			break
		case 7:
			stack7, buf = liftCratesPart1(stack7, buf, data.Count)
			break
		case 8:
			stack8, buf = liftCratesPart1(stack8, buf, data.Count)
			break
		case 9:
			stack9, buf = liftCratesPart1(stack9, buf, data.Count)
			break
		default:
			panic("Invalid From")
		}
